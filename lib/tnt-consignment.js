...
class TNTConsignment {
    ...
    async createConsignment(doShip = true, doBook = true, showBookingRef = true, emailRequired = false) {
        return this.shipRequest.createConsignment(doShip, doBook, showBookingRef, emailRequired);
    }
